...
import { SocialShareButton } from '@/app/lib/getClientConfig';
    ...
    <div className="flex justify-center space-x-3">
      {buttons.map((button, index) => (
        button.enabled && (
          <a
            key={index}
            href={getShareUrl(button.platform)}
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-700 transition-all hover:scale-110"
